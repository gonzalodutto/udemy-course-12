...
console.log(Math.max(5, 18, '23', 11, 2));
console.log(Math.max(5, 18, '23px', 11, 2)); // No funciona en este caso
...
console.log(new Date('Jun 17 2021 11:04:26'));
...
// Working with dates
const future = new Date(237, 10, 19, 15, 23);
console.log(future);
...
console.log(new Date(54660285792000));
...
const days1 = calcDaysPassed(new Date(1985, 9, 26), new Date(2021, 5, 19));
